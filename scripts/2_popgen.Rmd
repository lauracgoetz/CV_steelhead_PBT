...
This program takes way too long on all samples (same with STRUCTURE), so time to subset a random set of individuals.
...
ggsave(plot = fsty_gg, file = "../final_figures/S4_fstb.pdf", 
...
ggsave(plot = pca_1rgg, file = "../final_figures/S3_PCA.pdf", 
